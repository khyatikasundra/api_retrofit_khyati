...
abstract class _ProfileModel implements ProfileModel {
  const factory _ProfileModel(
      ...
      final String? ssn,
      final String? userAgent,
      final Crypto? crypto}) = _$ProfileModelImpl;
...
class _$CryptoImpl implements _Crypto {
  const _$CryptoImpl({this.coin, this.wallet, this.network});
...
abstract class _Hair implements Hair {
  const factory _Hair({final String? color, final String? type}) = _$HairImpl;
